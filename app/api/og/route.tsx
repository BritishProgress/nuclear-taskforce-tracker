        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#0B4938" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          >
            ...
            <div
              style={{
                ...
                justifyContent: 'center',
                padding: '60px 80px',
                backgroundColor: 'rgba(129, 244, 148, 0.2)', // neon-green/20
                borderRadius: '32px',
                border: '4px solid rgba(129, 244, 148, 0.3)',
                minWidth: '560px',
              }}
            >
              <div
            ...
            <div
              style={{
                ...
                justifyContent: 'center',
                padding: '60px 80px',
                backgroundColor: 'rgba(179, 6, 62, 0.1)', // deep-red/10
                borderRadius: '32px',
                border: '4px solid rgba(179, 6, 62, 0.2)',
                minWidth: '560px',
              }}
            >
              <div
              ...
              >
                <svg width="64" height="64" viewBox="0 0 24 24" fill="none" stroke="#B3063E" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
